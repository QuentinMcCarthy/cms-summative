...
$(document).ready(function(){
	...
	$("#single-post-content form")
		...
		.find("p:has('input:not([type=checkbox]):not([type=radio])')")
			.addClass("form-group")
			.end()
		.find("p:has('textarea')")
			.addClass("form-group")
		...
		.find("p:has('select')")
			.addClass("form-group")
			.end()
		.find("p:has('input[type=checkbox]')")
			.addClass("form-check")
			.end()
		.find("p:has('input[type=radio]')")
			.addClass("form-check")
			.end()
		.find("input:not([type=reset]):not([type=submit]):not([type=checkbox]):not([type=radio]):not([type=file]):not([type=range])")
